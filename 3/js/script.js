...
function displayPuppy(id) {
    ...
    // toDisplay creates a div, img, and div, which then gets append to
    ...
    //     <img class='clickable'>
    //     <div id='{id}'>
    var toDisplay = "<div class='name'>" + puppy.name + "</div><img class='clickable' src='" + puppy.pic + "'/><div id='" + id.toString() + "'>" + "Clicks: " + puppy.clicks.toString() + "</div>";
    ...
    $(".clickable").click(function(object) {
        // elem uses native JavaScript DOM properties to retrive
            // <div id='{id}'>.
...
// Run this code when the DOM is fully loaded (i.e., safe to manipulate).
